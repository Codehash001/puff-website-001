...
contract MaskTalisman is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  uint256 public PublicMintCost = 9.99 ether;
  ...
  ) ERC721A("MaskTalisman", "MaskTalisman") {
